...
/**
 * @credits Adapted from Full Stack Heroes <https://fullstackheroes.com/>
 */
...
<template>
<div
  class="relative flex h-full w-full items-start justify-start bg-[#E7F4EC]"
>
  <h1 class="px-20 pt-20 text-left text-7xl font-bold text-[#336E5A]">
    {{ title }}
  </h1>
  <p class="mt-4 px-20 text-left text-4xl font-medium text-[#336E5A]">
    {{ description }}
  </p>
